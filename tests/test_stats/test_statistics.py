...
# --------------- Unittest-style tests (from former test_mcmc_statistics.py) ---------------
...
class TestMCMCStatistics(unittest.TestCase):
    ...
    def test_order_zero_returns_one(self):
        ...
        out0_axis1 = ms.moment(x, order=0, axis=1)
    ...
    def test_all_equal_returns_zero_for_order_ge1(self):
        ...
        np.testing.assert_allclose(ms.moment(x, order=2, axis=1), 0.0)
